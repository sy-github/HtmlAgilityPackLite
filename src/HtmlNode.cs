...
namespace HtmlAgilityPack
{
	...
	public partial class HtmlNode
	{
        ...
        /// </summary>
        public HtmlNode FindChildByName(string name)
        {
            if (HasChildNodes)
            {
        ...
        /// <summary>
        /// Find first descendent node by given name
        /// </summary>
        public HtmlNode FindDescendantByName(string name)
        {
        ...
        /// <summary>
        /// Find first descendent node by given type
        /// </summary>
        public HtmlNode FindDescendantByType(HtmlNodeType type)
        {
            foreach (var node in Descendants())
            {
